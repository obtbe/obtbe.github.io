...
<style scoped>
  ...
  .article-flow {
    max-width: 600px;
    margin: 0 auto 0 calc(50% - 300px - 60px); /* Shift left by 60px */
    padding: 80px 50px;
    display: block;
  }
  ...
  .post-title, h1.post-title {
    ...
    margin: 0 auto 0 calc(50% - 300px - 60px) !important; /* Shift left by 60px */
  ...
  @media (max-width: 640px) {
    .article-flow {
      max-width: 100%;
      margin: 0 0 0 60px; /* Maintain 60px left shift */
      padding: 50px 25px;
    }
    ...
    .post-title, h1.post-title {
      ...
      margin: 0 0 0 60px !important; /* Maintain 60px left shift */
    }
  }
